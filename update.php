...
<input type='text' name='book' placeholder='Enter a book from the table'><br>
<input type='number' name='quan' placeholder='Enter new quantity' width='50px' height='20px'><br>
...
<div class="footer">
  ...
  <li>
    Contact Us:
    Email:deepakdepot@gmail.com
    Mobile No: +919959016307
  </li>
  </ul>
    </div>
</div> 
